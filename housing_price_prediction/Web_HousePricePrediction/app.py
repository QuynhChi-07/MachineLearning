...
from housing_price_prediction.bai2.FileUtil import FileUtil
...
def doprediction():
    ...
    trainedModel = FileUtil. loadmodel("../bai2/housingmodel.zip")
    result = trainedModel.predict([[area_income_value,area_house_age_value,area_number_of_rooms_value,area_number_of_bedrooms_value,area_population_value]])
    return f"{result[0]}"
