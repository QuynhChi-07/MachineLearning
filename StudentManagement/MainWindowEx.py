...
class MainWindowEx(Ui_MainWindow):
    def __init__(self):
        super().__init__()
        self.default_avtar="images/ic_no_avatar.jpg"
        self.id = None
        self.code = None
        self.name = None
        self.age = None
    ...
    """
    Viết mã lệnh kết nối MySQL Server, cơ sở dữ liệu studentmanagement (lưu ý nó là CSDL ở bài trước)
    """
    def connectMySQL(self):
        ...
        self.conn = pymysql.connect(
            ...
            password=password)
    """
    Viết lệnh truy vấn toàn bộ Student và hiển thị lên QTableWidget
    """
    def selectAllStudent(self):
        ...
        cursor.close()
    """
    Viết hàm hiển thị thông tin chi tiết student khi nhấn vào từng dòng dữ liệu trong QTableWidget
    """
    def processItemSelection(self):
        ...
        try:
            ...
            traceback.print_exc()
    """
    Viết lệnh chọn Avatar và xóa Avatar, có tạo base64string
    """
    def pickAvatar(self):
    ...
    def processRemove(self):
        ...
        self.clearData()
    """
    Viết hàm xóa dữ liệu trên giao diện của phần chi tiết
    """
    def clearData(self):
